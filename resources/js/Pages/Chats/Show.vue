        ...
        <template #header>
            <div class="flex flex-wrap items-center justify-between gap-3">
                ...
                <div class="flex w-full flex-wrap items-center gap-2 sm:w-auto">
                    <Link :href="route('chats.demo', chat.id)" target="_blank" rel="noopener noreferrer" class="inline-flex flex-1 items-center justify-center rounded-md border border-indigo-300 bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-700 shadow-sm transition hover:bg-indigo-100 sm:flex-none sm:px-4">
                    ...
                    <Link :href="route('chats.edit', chat.id)" class="inline-flex flex-1 items-center justify-center rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 sm:flex-none sm:px-4">
                        <svg class="-ml-1 mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                        Редактировать
                    </Link>
                    <button @click="confirmDeletion" class="inline-flex flex-1 items-center justify-center rounded-md border border-red-300 bg-white px-3 py-2 text-sm font-medium text-red-700 shadow-sm transition hover:bg-red-50 sm:flex-none sm:px-4">
                        <svg class="-ml-1 mr-2 h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
